    ...
    routes: {
        ...
        function: function(status, model) {
          return function() {
            return function(req, res) {
              res.status(status).json({data: model.getAll()});
            };
          };
        }
      },
        ...
        function: function(status, model) {
          return function() {
            return function(req, res) {
              ...
              res.status(status).json(model.findById(req.params.id));
            };
          };
        }
      },
      add: {
        ...
        function: function(status, model) {
          return function() {
            return function(req, res) {
              res.status(status).json({ data: model.add(req.body) });
            };
          };
        }
      },
      remove: {
        ...
        function: function(status, model) {
          return function() {
            return function(req, res) {
              res.status(status).json({ data: model.remove(req.params.id) });
            };
          };
        }
      },
      update: {
        ...
        function: function(status, model) {
          return function() {
            return function(req, res) {
              res.status(status).json({data: model.update(req.params.id, req.body) });
            };
          };
        }
      }
